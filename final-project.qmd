...
Before starting the machine learning process, we used package `plotly` to map the average violent and property crime rates across the U.S. from 2009 to 2014, displayed on a state-by-state basis for better understanding.
