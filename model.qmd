...
crime_2016<-read_dta(here("data","ICPSR_37059","DS0004","37059-0004-Data.dta"))
```
...
# predictive data and implementation data
...
### ses
SES predictive data of 2010 is from ACS five-year estimate from 2008 to 2012.
SES implementation data of 2016 is from ACS five-years estimate from 2013 to 2016.
...
# EDA and Data cleaning of predictive data in 2010
...
missing_values <- colSums(is.na(crime_all_2010_cleaned))
...
missing_values_percent<-missing_values|>
  mutate(missing_percent = missing_values/nrow(crime_all_2010_cleaned))|>
  arrange(desc(missing_percent))|>
  top_n(10)
```

# EDA and Data cleaning of implementation data in 2016
...
# explore missing values
missing_values <- colSums(is.na(crime_all_2016_cleaned))
...
# look at the variables with the most missing values, no variable has over 50% missing values
missing_values_percent<-missing_values|>
  mutate(missing_percent = missing_values/nrow(crime_all_2016_cleaned))|>
  arrange(desc(missing_percent))|>
  top_n(10)
```
# Splitting Data
