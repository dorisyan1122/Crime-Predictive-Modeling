...
crime_all_cleaned <- crime_all|>
  ...
  mutate(log_viol = log((viol / totpop13_17) * 100000),
       log_property = log((property / totpop13_17) * 100000)) |>
...
rf_v_fit|>
  ...
  labs(title = "Top 30 Important Variables for Violent Crime Prediction") +
  geom_col()
